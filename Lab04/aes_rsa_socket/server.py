...
# List of connected clients (corrected from 'client' to 'clients')
clients = []
...
def handle_client(client_socket, client_address):
    ...
    encrypted_aes_key = PKCS1_OAEP.new(client_received_key).encrypt(aes_key)
    ...
    while True:
        try:
            ...
            for client_sock, client_key in clients:
                if client_sock != client_socket:
                    encrypted = encrypt_message(client_key, decrypted_message)
